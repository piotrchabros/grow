...
const services = [
  ...
  { num: '02', titleKey: 'services.transformation.title', descKey: 'services.transformation.description' },
  { num: '03', titleKey: 'services.optimization.title', descKey: 'services.optimization.description' },
];
